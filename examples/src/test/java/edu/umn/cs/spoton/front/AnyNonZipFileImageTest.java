...
@RunWith(JQF.class)
public class AnyNonZipFileImageTest {

  @BeforeClass
  public static void setup() {
    InternalConfig.resetInstance();
    FileGenerator.fileTypeTest = FileType.IMGE;
    FileGenerator.filenameTest =  InternalConfig.getInstance().LOCAL_FUZZDIR + "/file.png";
